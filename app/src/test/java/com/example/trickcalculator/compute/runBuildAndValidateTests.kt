...
private fun testValidateErrors() {
    ...
    var text = listOf("+")
    assertSyntaxError { buildAndValidateComputeText(null, text, ops, null, true, true) }
    ...
    assertSyntaxError { buildAndValidateComputeText(null, text, partialOps, null, true, true) }
...
private fun testBuildText() {
    ...
    assertEquals(expected, buildAndValidateComputeText(initialValue, text, ops, null, true, true))
...
private fun testBuildTextWithMods() {
    ...
    assertEquals(expected, buildAndValidateComputeText(null, text, ops, order, true, true))
    ...
    assertEquals(
        expected,
        buildAndValidateComputeText(null, text, ops, null, applyParens = false, true)
    )
    ...
    assertEquals(
        expected,
        buildAndValidateComputeText(null, text, ops, null, false, applyDecimals = false)
    )
    ...
    assertEquals(
        expected,
        buildAndValidateComputeText(ef, text, ops, null, applyParens = false, true)
    )
