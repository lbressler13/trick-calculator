...
internal fun runGetSimplifiedTests() {
    ...
    term = Term(
        ExactFraction.TWO,
        listOf(Sqrt(64), Sqrt(ExactFraction(75, 98)), Sqrt(26))
    )
    ...
    term = Term(
        ExactFraction.FOUR,
        listOf(Log(100), Sqrt(9), Sqrt(ExactFraction(1, 4)))
    )
    ...
    term = Term(
        -ExactFraction.EIGHT,
        listOf(Pi(true), Sqrt(ExactFraction(27, 98)))
    )
    ...
    term = Term(
        ExactFraction(20),
        listOf(Log(ExactFraction(1, 27), 3, true))
    )
    ...
    term = Term(
        ExactFraction.EIGHT,
        listOf(Sqrt(ExactFraction(1, 46)))
    )
    expectedCoeff = ExactFraction.EIGHT
...
internal fun runGetValueTests() {
    ...
    term = Term(
        ExactFraction.SEVEN,
        listOf(Log(ExactFraction(6, 7), 4), Pi(), Log(40))
    )
